/* - - Greg Molenaar    - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
/* - - Entered default VALUEs for lat1/lon1 and 2 about line 343  */
/* - - Fixed the link to MT with the full file name latlong-map.html  */
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
/*
...
// -- Greg Molenaar  -- see modes in line about 343                                        -- //
// -- Create initial lat - lon points for the distance & display defaults -- but this was not acceptable format -- //
var P01a = ("45 18.8496 N" );  // 45 18.8496 N - 094 56.2626 W
var P01b = "094 56.2626 W"  ;
var P02a = "45 18.8462 N" ;    // --  45 18.8462 N - 094 56.31216W = 212.91' at 264°25′42″
var P02b = "094 56.31216 W" ;

function getDistance(Msg,LatLng1,LatLng2){
  var R = 6371; // km
  var dLat = (LatLng2.lat()-LatLng1.lat()).toRad();
  var dLon = (LatLng2.lng()-LatLng1.lng()).toRad();
  var lat1 = LatLng1.lat().toRad();
  var lat2 = LatLng1.lat().toRad();
  ...
  console.log('Distance between ' + Msg + ' is :' + d*1000);
  return d*1000;
}
...
LatLon.distHaversineFT = function(lat1, lon1, lat2, lon2) {
  var R = 6371; // earth's mean radius in km
  var dLat = (lat2-lat1).toRad();
  var dLon = (lon2-lon1).toRad();
  lat1 = lat1.toRad(), lat2 = lat2.toRad();
...
/* -- note the above function returns FEET as per Greg Molenaar (New London, MN).
...
LatLon.prototype.toGoogleLatLng = function() {
